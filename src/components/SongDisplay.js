    ...
    render() {
        if (this.props.displayedSong) { 
            ...
            <div>
                ...
                <p>If YouTube embed doesn't work, click <a href={this.props.displayedSong.url} target="_blank">HERE</a></p>
                ...
                <p>from the album <a href={this.props.displayedSong.image} target="_blank">{this.props.displayedSong.album} ({this.props.displayedSong.year})</a></p>
